...
import Button from "./components/tampilan/Button";
import { Collapse } from "./components/tampilan/Collapse";
import SpeakerCard from "./components/tampilan/SpeakerCard";
import { Card } from "./components/tampilan/Card";
  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto">
        <section
          id="hero"
          className="py-20 flex gap-10 justify-center items-center "
        >
        ...
        <section id="speaker" className="py-24">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-16 px-3">
        ...
        <section
          id="cards"
          className="py-30 grid grid-cols-1 md:grid-cols-2 gap-16 px-4"
        >
        ...
        <section id="collapse" className="py-24 flex flex-end gap-2 px-3">
